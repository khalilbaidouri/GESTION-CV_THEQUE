...
// Affiche les langues d'un utilisateur depuis le fichier
...
// Wrapper pour suppression qui garde la signature
...
// Met à jour une langue (avec nettoyage)
...
// Gestion des langues (paramètre tete conservé, mais non utilisé)
