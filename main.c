...
int main() {
    ...
    dernier_id_cv = lire_dernier_id("cvs.txt");
    dernier_id_profilmotivation = lire_dernier_id("profils_motivation.txt");  // Nouveau

    // Initialiser les listes chaînées
    ...
    Langue* langues = NULL;
    CV* cvs = NULL;
    ProfilMotivation* profilsMotivation = NULL;  // Nouveau
    ...
    do {
        ...
        printf("2. Gestion profils/motivation\n");
        printf("3. Gestion des educations\n");
        printf("4. Gestion des experiences\n");
        printf("5. Gestion des certificats\n");
        printf("6. Gestion des loisirs\n");
        printf("7. Gestion des skills\n");
        printf("8. Gestion des langues\n");
        printf("9. Afficher mon CV\n");
        printf("0. Quitter\n");
        printf("Choix : ");
        scanf(" %c", &choix);
        while (getchar() != '\n'); // Vider buffer
        ...
        switch (choix) {
            ...
            case '2':
                if (id_utilisateur_courant == 0) {
                    ...
                    gestion_profils_motivation("profils_motivation.txt");
                }
            break;
